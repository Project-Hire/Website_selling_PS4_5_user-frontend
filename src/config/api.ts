...
export const API_UPDATE_PROFILE = `${API}/auth/update_profile`
export const API_USER_PROFILE = `${API}/auth/user_profile`
...
export const API_GET_PAYMENT_CD_GAME_HISTORY = `${API}/payment_cdGame/history`
