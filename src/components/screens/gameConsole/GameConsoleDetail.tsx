...
const GameConsoleDetail = () => {
  ...
  const { data: gameConsole } = useGameConsoleDetailQuery(router.query.id as string)
  const data: CDGamDetailData = gameConsole?.data
  const image: string[] = useMemo(() => data?.image?.split(','), [gameConsole])
    ...
    <Layout>
      <div className="cd-game">
        ...
        <div className="cd-game-description">
          <div className="cd-game-description__title">Chi tiet san pham: </div>
